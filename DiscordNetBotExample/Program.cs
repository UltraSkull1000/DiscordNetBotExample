...
namespace DiscordBot; // All elements of the program should be under this namespace. Feel free to rename.

public class DiscordBot() // I recommend changing the name of this class to match the namespace above. 
{
